...
const obtenerGenerosSinRepetir = (movies) => {
  ...
  movies.forEach((movie) => {
    if (!generosUnicos.includes(movie.genre)) {
      generosUnicos.push(movie.genre);
    }
  });
...
const obtenerDirectoresSinRepetir = (movies) => {
  ...
  movies.forEach((movie) => {
    if (!directoresUnicos.includes(movie.director)) {
      directoresUnicos.push(movie.director);
    }
  });
...
const obtenerActoresProtagonistasSinRepetir = (movies) => {
  const actores = movies.reduce((acumulador, movie) => {
    ...
    nombresActores.forEach((nombreActor) => {
      if (!acumulador.includes(nombreActor)) {
        acumulador.push(nombreActor);
      }
    });
    return acumulador;
  }, []);
...
console.log(
  ...
  obtenerActoresProtagonistasSinRepetir(movies)
);
...
const obtenerClasificacionesSinRepetir = (movies) => {
  ...
  movies.forEach((movie) => {
    if (!clasificacionesUnicas.includes(movie.rating)) {
      clasificacionesUnicas.push(movie.rating);
    }
  });
...
console.log(
  ...
  obtenerClasificacionesSinRepetir(movies)
);
...
console.log(
  ...
  obtenerPeliculasPorDuracion(movies, 100, 120)
);
...
console.log(
  ...
  obtenerPeliculasPorClasificacion(movies, "R")
);
...
console.log(
  ...
  obtenerPeliculasPorRangoDeAños(movies, 2000, 2010)
);
...
console.log(
  ...
  obtenerPeliculasPorPais(movies, "Estados Unidos")
);
...
const obtenerCantidadPeliculasPorClasificacion = (movies) => {
  ...
  movies.forEach((movie) => {
    ...
    clasificaciones[clasificacion] = clasificaciones[clasificacion]
...
console.log(
  ...
  obtenerCantidadPeliculasPorClasificacion(movies)
);
...
console.log(
  ...
  obtenerCantidadPeliculasPorPais(movies)
);
...
const obtenerEdadPromedioActoresProtagonistas = (movies) => {
  ...
  const sumaEdades = movies.reduce((suma, movie) => {
    const edades = movie.protagonists.map((actor) => actor.age);
...
console.log(
  ...
  obtenerEdadPromedioActoresProtagonistas(movies)
);
...
console.log(
  ...
  obtenerCantidadPeliculasPorActor(movies, "Leonardo DiCaprio")
);
